...
def test_build_text_field():
    ...
    FormClass = build_document_form(schema)
...
def test_field_labels_are_applied():
    ...
    assert form.fields["main_text"].label == "Main Text"


def test_initial_values_are_loaded():
